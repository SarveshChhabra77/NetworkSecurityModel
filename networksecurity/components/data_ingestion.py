...
from networksecurity.entity.artifact_entity import DataIngestionArtificats
...
class DataIngestion:
    ...
    def export_data_into_feature_store(self,dataframe:pd.DataFrame):
        try:
            ...
            ## header=false  will remove columns names 
        except Exception as e:
            raise NetworkSecurityException(e,sys)
    ...
    def initiate_data_ingestion(self):
        try:
            ...
            dataingestionartifact=DataIngestionArtificats(trained_file_path=self.data_ingestion_config.train_file_path,tested_file_path=self.data_ingestion_config.test_file_path)
